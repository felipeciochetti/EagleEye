...
public class LinhaTempoDocumento implements Serializable {

	StringBuffer sb = new StringBuffer("");
	String param = "";
	static final String ICONE = "certified";

	public LinhaTempoDocumento() {
	}
	...
	private String gerarPrimeiraFase(){
		...
		sb.append("<tr>");
		sb.append("<td id=\"tdLineFirst\" class=\"stgTdLinePrev\" style=\"width: 10.0%;\"></td>");
	...
	private String gerarUltimaFase(){
		...
		sb.append("<td id=\"tdLineLast\" style=\"width: 10.0%;\"></td></tr><tr>");
	...
	private String gerarFaseCompletada(){
		...
		sb.append("<div id=\"stgIcon1\" class=\"stgIcon "+ ICONE +" completed\">");
	...
	private String gerarFaseProcessando(){
		...
		sb.append("<div id=\"stgIcon1\" class=\"stgIcon "+ ICONE +" processing\">");
	...
	private String gerarFaseAguardando(){
		...
		sb.append("<div id=\"stgIcon1\" class=\"stgIcon "+ ICONE +" waiting\">");
	...
	private String gerarFaseCancelada(){
		...
		sb.append("<div id=\"stgIcon1\" class=\"stgIcon "+ ICONE +" canceled\">");
	...
	private String gerarEntreCompletadaProcessando(){
		...
		sb.append("<td colspan=\"2\" class=\"stgTdLineBetween\" style=\"width: 20.0%;\">");
	...
	public String gerarInicioCabecalho(int qtd){
		...
		sb.append("<table id=\"timeLineTable\" class=\"tlTable tl\" border=\"0\">"+
				"<tbody>");
