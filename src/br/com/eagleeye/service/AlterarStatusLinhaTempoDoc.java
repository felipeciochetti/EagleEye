...
public class AlterarStatusLinhaTempoDoc implements Serializable{
	...
	public String  gravarAlteracaoStatusLinhaTempoDoc(Processo processo ,LinhaTempoDocProcesso faseAlterada ){
		...
		Set<LinhaTempoDocProcesso> list = processo.getLinhaTempoProcesso();

		for (LinhaTempoDocProcesso faseAnterior : list) {
