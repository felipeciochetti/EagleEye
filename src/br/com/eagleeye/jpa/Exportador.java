...
@NamedQuery(name="Exportador.buscaTodos", query="select c from Exportador c")
...
public class Exportador  implements Serializable{
	...
	private Set<ExportadorContato> clienteContato;
	
	
	public long getIdExportador() {
		return idExportador;
	}
	public void setIdExportador(long idExportador) {
	...
	public Set<ExportadorContato> getExportadorContato() {
			return clienteContato;
	}
	public void setExportadorContato(Set<ExportadorContato> clienteContato) {
